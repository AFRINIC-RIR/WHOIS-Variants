...
@Named
@Scope("prototype")
public class Rpsl2CouchdbCommand implements Command<String, String> {
        ...
        try {
            ...
            while ((line1 = br.readLine()) != null) {
                if (!line1.startsWith("%%")) {
                    line = line1.split(":");
                    if (i == 0) {
                        json.append(quotation).append("_id").append(quotation)
                                .append(":").append(quotation)
                                .append(line[0].trim()).append(" ")
                                .append(line[1].trim()).append(quotation).append(",");
                    }
